(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["node_modules_angular_router_fesm2020_router_mjs-_6f000"],{
...
/* harmony export */ });
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common */ 1327);
...
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ 6209);
/* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/platform-browser */ 5253);
/**
...
function assertStandalone(fullPath, component) {
  if (component && !(0,_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵisStandalone"])(component)) {
...
const activateRoutes = (rootContexts, routeReuseStrategy, forwardEvent) => (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(t => {
    ...
    if (future === curr) {
      ...
      if (future.component) {
        ...
        if (this.routeReuseStrategy.shouldAttach(future.snapshot)) {
          ...
          const cmpFactoryResolver = injector?.get(_angular_core__WEBPACK_IMPORTED_MODULE_1__.ComponentFactoryResolver) ?? null;
          context.attachRef = null;
...
function prioritizedGuardValue() {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.switchMap)(obs => {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.combineLatest)(obs.map(o => o.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.take)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.startWith)(INITIAL_VALUE)))).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.scan)((acc, list) => {
      let isPending = false;
    ...
    }, INITIAL_VALUE), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(item => item !== INITIAL_VALUE), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(item => isUrlTree(item) ? item : item === true), //
...
function noMatch(segmentGroup) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.throwError)(new NoMatch$1(segmentGroup));
}
...
function namedOutletsRedirect(redirectTo) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.throwError)(new Error(`Only absolute redirects can have named outlets. redirectTo: '${redirectTo}'`));
}

function canLoadFails(route) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.throwError)(navigationCancelingError(`Cannot load children because the guard of the route "path: '${route.path}'" returned false`));
}
/**
...
class ApplyRedirects {
  ...
  apply() {
    ...
    const urlTrees$ = expanded$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(rootSegmentGroup => {
      return this.createUrlTree(squashSegmentGroup(rootSegmentGroup), this.urlTree.queryParams, this.urlTree.fragment);
    }));
    return urlTrees$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.catchError)(e => {
  ...
  match(tree) {
    ...
    const mapped$ = expanded$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(rootSegmentGroup => {
      return this.createUrlTree(squashSegmentGroup(rootSegmentGroup), tree.queryParams, tree.fragment);
    }));
    return mapped$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.catchError)(e => {
      if (e instanceof NoMatch$1) {
        throw this.noMatchError(e);
      }
  ...
  expandSegmentGroup(injector, routes, segmentGroup, outlet) {
    if (segmentGroup.segments.length === 0 && segmentGroup.hasChildren()) {
      return this.expandChildren(injector, routes, segmentGroup).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(children => new UrlSegmentGroup([], children)));
    }
  ...
  expandChildren(injector, routes, segmentGroup) {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(childOutlets).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.concatMap)(childOutlet => {
      ...
      return this.expandSegmentGroup(injector, sortedRoutes, child, childOutlet).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(s => ({
        segment: s,
        outlet: childOutlet
      })));
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.scan)((children, expandedChild) => {
  ...
  expandSegment(injector, segmentGroup, routes, segments, outlet, allowRedirects) {
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(routes).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.concatMap)(r => {
    ...
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.first)(s => !!s), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.catchError)((e, _) => {
  ...
  expandWildCardWithParamsAgainstRouteUsingRedirect(injector, routes, route, outlet) {
    ...
    return this.lineralizeSegments(route, newTree).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeMap)(newSegments => {
  ...
  matchSegmentAgainstRoute(injector, rawSegmentGroup, route, segments, outlet) {
    if (route.path === '**') {
      ...
      if (route.loadChildren) {
        ...
        return loaded$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(cfg => {
    ...
    return childConfig$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeMap)(routerConfig => {
      ...
      if (slicedSegments.length === 0 && segmentGroup.hasChildren()) {
        ...
        return expanded$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(children => new UrlSegmentGroup(consumedSegments, children)));
      }
      ...
      return expanded$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(cs => new UrlSegmentGroup(consumedSegments.concat(cs.segments), cs.children)));
    }));
  }
  ...
  getChildConfig(injector, route, segments) {
    ...
    if (route.loadChildren) {
      ...
      return this.runCanLoadGuards(injector, route, segments).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeMap)(shouldLoadResult => {
        if (shouldLoadResult) {
  ...
  runCanLoadGuards(injector, route, segments) {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(canLoadObservables).pipe(prioritizedGuardValue(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.tap)(result => {
...
function applyRedirects(environmentInjector, configLoader, urlSerializer, config) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.switchMap)(t => applyRedirects$1(environmentInjector, configLoader, urlSerializer, t.extractedUrl, config).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(urlAfterRedirects => ({ ...t,
    urlAfterRedirects
  }))));
}
/**
...
function checkGuards(moduleInjector, forwardEvent) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeMap)(t => {
    ...
    return runCanDeactivateChecks(canDeactivateChecks, targetSnapshot, currentSnapshot, moduleInjector).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeMap)(canDeactivate => {
    ...
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(guardsResult => ({ ...t,
      guardsResult
    })));
  });
}
...
function runCanDeactivateChecks(checks, futureRSS, currRSS, moduleInjector) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(checks).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeMap)(check => runCanDeactivate(check.component, check.route, currRSS, futureRSS, moduleInjector)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.first)(result => {
    return result !== true;
  }, true));
}

function runCanActivateChecks(futureSnapshot, checks, moduleInjector, forwardEvent) {
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(checks).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.concatMap)(check => {
...
class Recognizer {
  ...
  processSegmentAgainstRoute(route, rawSegment, segments, outlet) {
    ...
    if (route.path === '**') {
      ...
      NG_DEV_MODE$2 ? getCorrectedPathIndexShift(rawSegment) + segments.length : pathIndexShift);
    } else {
      ...
      }), this.urlTree.fragment, getData(route), getOutlet(route), route.component ?? route._loadedComponent ?? null, route, getSourceSegmentGroup(rawSegment), pathIndexShift, getResolve(route), NG_DEV_MODE$2 ? getCorrectedPathIndexShift(rawSegment) + consumedSegments.length : pathIndexShift);
    }
...
function recognize(rootComponentType, config, serializer, paramsInheritanceStrategy, relativeLinkResolution) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeMap)(t => recognize$1(rootComponentType, config, t.urlAfterRedirects, serializer(t.urlAfterRedirects), paramsInheritanceStrategy, relativeLinkResolution).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(targetSnapshot => ({ ...t,
    targetSnapshot
  }))));
}
/**
...
function resolveData(paramsInheritanceStrategy, moduleInjector) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeMap)(t => {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(canActivateChecks).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.concatMap)(check => runResolve(check.route, targetSnapshot, paramsInheritanceStrategy, moduleInjector)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.tap)(() => canActivateChecksResolved++), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeLast)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeMap)(_ => canActivateChecksResolved === canActivateChecks.length ? (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(t) : rxjs__WEBPACK_IMPORTED_MODULE_2__.EMPTY));
  });
}
...
function runResolve(futureARS, futureRSS, paramsInheritanceStrategy, moduleInjector) {
  ...
  return resolveNode(resolve, futureARS, futureRSS, moduleInjector).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(resolvedData => {
...
function resolveNode(resolve, futureARS, futureRSS, moduleInjector) {
  ...
  const data = {};
  return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(keys).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeMap)(key => getResolver(resolve[key], futureARS, futureRSS, moduleInjector).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.first)(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.tap)(value => {
    data[key] = value;
  }))), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.takeLast)(1), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mapTo)(data), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.catchError)(e => e instanceof rxjs__WEBPACK_IMPORTED_MODULE_2__.EmptyError ? rxjs__WEBPACK_IMPORTED_MODULE_2__.EMPTY : (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.throwError)(e)));
}
...
function switchTap(next) {
  return (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.switchMap)(v => {
    ...
    if (nextResult) {
      return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(nextResult).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(() => v));
    }
...
class RouterConfigLoader {
  ...
  loadComponent(route) {
    ...
    const loadRunner = wrapIntoObservable(route.loadComponent()).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.tap)(component => {
    ...
    const loader = new rxjs__WEBPACK_IMPORTED_MODULE_2__.ConnectableObservable(loadRunner, () => new rxjs__WEBPACK_IMPORTED_MODULE_2__.Subject()).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.refCount)());
  ...
  loadChildren(parentInjector, route) {
    ...
    const loadRunner = moduleFactoryOrRoutes$.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(factoryOrRoutes => {
      if (this.onLoadEndListener) {
        this.onLoadEndListener(route);
      ...
      if (Array.isArray(factoryOrRoutes)) {
        ...
        rawRoutes = flatten(injector.get(ROUTES, [], _angular_core__WEBPACK_IMPORTED_MODULE_1__.InjectFlags.Self | _angular_core__WEBPACK_IMPORTED_MODULE_1__.InjectFlags.Optional));
      }
  ...
  loadModuleFactoryOrRoutes(loadChildren) {
    return wrapIntoObservable(loadChildren()).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeMap)(t => {
...
RouterConfigLoader.ɵfac = function RouterConfigLoader_Factory(t) {
  return new (t || RouterConfigLoader)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__.Injector), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__.Compiler));
};
...
class Router {
  ...
  setupNavigations(transitions) {
    ...
    return transitions.pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.filter)(t => t.id !== 0), // Extract URL
    (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.map)(t => ({ ...t,
    ...
    (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.switchMap)(t => {
      ...
      })), checkGuards(this.ngModule.injector, evt => this.triggerEvent(evt)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.tap)(t => {
      ...
      switchTap(t => {
        if (t.guards.canActivateChecks.length) {
          return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(t).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.tap)(t => {
            const resolveStart = new ResolveStart(t.id, this.serializeUrl(t.extractedUrl), this.serializeUrl(t.urlAfterRedirects), t.targetSnapshot);
            this.triggerEvent(resolveStart);
          }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.switchMap)(t => {
            let dataResolved = false;
            return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(t).pipe(resolveData(this.paramsInheritanceStrategy, this.ngModule.injector), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.tap)({
      ...
      switchTap(t => {
        ...
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.combineLatest)(loadComponents(t.targetSnapshot.root)).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.defaultIfEmpty)(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.take)(1));
      ...
      }), activateRoutes(this.rootContexts, this.routeReuseStrategy, evt => this.triggerEvent(evt)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.tap)({
        next() {
          completed = true;
        },
...
class RouterLink {
  ...
  onClick() {
    ...
    const extras = {
      skipLocationChange: (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵcoerceToBoolean"])(this.skipLocationChange),
      replaceUrl: (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵcoerceToBoolean"])(this.replaceUrl),
      state: this.state
    };
  ...
  get urlTree() {
    ...
    return this.router.createUrlTree(this.commands, {
      ...
      preserveFragment: (0,_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵcoerceToBoolean"])(this.preserveFragment)
    });
  }
...
class RouterLinkActive {
  ...
  ngAfterContentInit() {
    ...
    (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(this.links.changes, this.linksWithHrefs.changes, (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(null)).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeAll)()).subscribe(_ => {
      this.update();
  ...
  subscribeToEachLinkOnChanges() {
    ...
    this.linkInputChangesSubscription = (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(allLinkChanges).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeAll)()).subscribe(link => {
...
DefaultTitleStrategy.ɵfac = function DefaultTitleStrategy_Factory(t) {
  return new (t || DefaultTitleStrategy)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__.Title));
};
...
class PreloadAllModules {
  preload(route, fn) {
    return fn().pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.catchError)(() => (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(null)));
  }
...
class RouterPreloader {
  ...
  processRoutes(injector, routes) {
    ...
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)(res).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeAll)());
  }
  ...
  preloadConfig(injector, route) {
    return this.preloadingStrategy.preload(route, () => {
      ...
      if (route.loadComponent && !route._loadedComponent) {
        ...
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.from)([recursiveLoadChildren$, loadComponent$]).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_3__.mergeAll)());
      } else {
...
const ROUTER_PROVIDERS = [_angular_common__WEBPACK_IMPORTED_MODULE_0__.Location, {
  ...
  deps: [UrlSerializer, ChildrenOutletContexts, _angular_common__WEBPACK_IMPORTED_MODULE_0__.Location, _angular_core__WEBPACK_IMPORTED_MODULE_1__.Injector, _angular_core__WEBPACK_IMPORTED_MODULE_1__.Compiler, ROUTES, ROUTER_CONFIGURATION, DefaultTitleStrategy, [TitleStrategy, new _angular_core__WEBPACK_IMPORTED_MODULE_1__.Optional()], [UrlHandlingStrategy, new _angular_core__WEBPACK_IMPORTED_MODULE_1__.Optional()], [RouteReuseStrategy, new _angular_core__WEBPACK_IMPORTED_MODULE_1__.Optional()]]
...
const VERSION = new _angular_core__WEBPACK_IMPORTED_MODULE_1__.Version('14.0.3');
/**
 * @license
 * Copyright Google LLC All Rights Reserved.
 *
